    ...
    function cRender(){
      ...
      */
      ...
      if(t<=.88){
        ...
        const q=cSmooth(cClamp((t-.88)/.112));
        pt={
          x:cornerX,
        ...
        const q=cSmooth(cClamp((t-.992)/.008));
        pt={
